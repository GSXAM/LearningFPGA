...
HD_PWD='D:/VHDL/Basys3_18N39/Comparator4bit/Comparator4bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Comp_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Comp_4bit.tcl -notrace
