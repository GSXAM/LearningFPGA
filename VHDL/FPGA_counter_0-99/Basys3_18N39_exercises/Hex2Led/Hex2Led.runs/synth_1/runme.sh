...
HD_PWD='D:/VHDL/Basys3_18N39/Hex2Led/Hex2Led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hex2led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hex2led.tcl
