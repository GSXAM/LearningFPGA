...
HD_PWD='D:/VHDL/Basys3_18N39/Mux2to1_4bit/Mux2to1_4bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux2to1_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mux2to1_4bit.tcl -notrace
