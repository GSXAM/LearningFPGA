...
HD_PWD='D:/VHDL/Basys3_18N39/Counter0to9_7seg/Counter0to9_7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter100_updown.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Counter100_updown.tcl
