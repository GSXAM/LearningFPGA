...
HD_PWD='D:/VHDL/Basys3_18N39/Counter0to9_7seg/Counter0to9_7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter100_updown.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Counter100_updown.tcl -notrace
