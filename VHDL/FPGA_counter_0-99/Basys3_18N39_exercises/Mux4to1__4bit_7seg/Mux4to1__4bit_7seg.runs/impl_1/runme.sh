...
HD_PWD='D:/VHDL/Basys3_18N39/Mux4to1__4bit_7seg/Mux4to1__4bit_7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux4to1_4bit_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mux4to1_4bit_7seg.tcl -notrace
