...
HD_PWD='D:/VHDL/Basys3_18N39/Mux2to1_4bit/Mux2to1_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux2to1_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux2to1_4bit.tcl
