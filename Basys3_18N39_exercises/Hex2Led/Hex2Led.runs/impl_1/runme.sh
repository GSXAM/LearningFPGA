...
HD_PWD='D:/VHDL/Basys3_18N39/Hex2Led/Hex2Led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hex2led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hex2led.tcl -notrace
