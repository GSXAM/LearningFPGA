...
HD_PWD='D:/VHDL/Basys3_18N39/Comparator4bit/Comparator4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Comp_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Comp_4bit.tcl
